...
extern NSString *const WINDOW_HINTS_TITLE_SHOW;
extern NSString *const WINDOW_HINTS_TITLE_SHOW_DEFAULT;
extern NSString *const WINDOW_HINTS_TITLE_FONT_NAME;
extern NSString *const WINDOW_HINTS_TITLE_FONT_NAME_DEFAULT;
extern NSString *const WINDOW_HINTS_TITLE_FONT_SIZE;
extern NSString *const WINDOW_HINTS_TITLE_FONT_SIZE_DEFAULT;
extern NSString *const WINDOW_HINTS_TITLE_FONT_COLOR;
extern NSString *const WINDOW_HINTS_TITLE_FONT_COLOR_DEFAULT;
extern NSString *const WINDOW_HINTS_TITLE_BACKGROUND_COLOR;
extern NSString *const WINDOW_HINTS_TITLE_BACKGROUND_COLOR_DEFAULT;
...
extern NSString *const WINDOW_HINTS_FONT_STROKE_SIZE;
extern NSString *const WINDOW_HINTS_FONT_STROKE_SIZE_DEFAULT;
extern NSString *const WINDOW_HINTS_FONT_STROKE_COLOR;
extern NSString *const WINDOW_HINTS_FONT_STROKE_COLOR_DEFAULT;
