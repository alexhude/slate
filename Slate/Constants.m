...
NSString *const WINDOW_HINTS_TITLE_SHOW = @"windowHintsTitleShow";
NSString *const WINDOW_HINTS_TITLE_SHOW_DEFAULT = @"true";
NSString *const WINDOW_HINTS_TITLE_FONT_NAME = @"windowHintsTitleFontName";
NSString *const WINDOW_HINTS_TITLE_FONT_NAME_DEFAULT = @"Helvetica";
NSString *const WINDOW_HINTS_TITLE_FONT_SIZE = @"windowHintsTitleFontSize";
NSString *const WINDOW_HINTS_TITLE_FONT_SIZE_DEFAULT = @"11";
NSString *const WINDOW_HINTS_TITLE_FONT_COLOR = @"windowHintsTitleFontColor";
NSString *const WINDOW_HINTS_TITLE_FONT_COLOR_DEFAULT = @"255;255;255;1.0";
NSString *const WINDOW_HINTS_TITLE_BACKGROUND_COLOR = @"windowHintsTitleBackgroundColor";
NSString *const WINDOW_HINTS_TITLE_BACKGROUND_COLOR_DEFAULT = @"50;53;58;0.9";
...
NSString *const WINDOW_HINTS_FONT_STROKE_SIZE = @"windowHintsFontStrokeSize";
NSString *const WINDOW_HINTS_FONT_STROKE_SIZE_DEFAULT = @"0";
NSString *const WINDOW_HINTS_FONT_STROKE_COLOR = @"windowHintsFontStrokeColor";
NSString *const WINDOW_HINTS_FONT_STROKE_COLOR_DEFAULT = @"0;0;0;1.0";
